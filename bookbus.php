...
<div class="container2">
  ...
  <option>Kurmanapalem</option>
   <option>RK Hospital</option>
   <option>Gajuwaka</option>
   <option>B H P V</option>
   <option>Sheelanagar</option>
   <option>Airport</option>
   <option>Kakaninagar</option>
   <option>NAD Junction</option>
   <option>Marripalem</option>
   <option>Passport Office</option> 
   <option>Urvashi</option>
   <option>NGGOS Colony</option> 
   <option>Gurudwara</option>
   <option>Maddilapalem</option> 
   <option>Isukathota</option> 
   <option>PM Palem</option>
   <option>Hanumanthawaka</option>
   <option>Zoo Park</option> 
